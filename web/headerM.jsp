...
<header>
    <section>
        <form action="HeaderMServlet" method="post">
            <!-- MAIN CONTAINER -->
            <div id="container">
                <!-- WEB NAME -->
                <div id="webName"> <b>Tour</b>Share </div>
                <!-- COLLCETIONS ON WEBSITE -->
                <div id="collection">
                    <div id="faRoutes"><a href="./routeManage.jsp"> ROUTE MANAGE </a></div>
                ...
                <div id="user">
                    <a href="userManage.jsp"> <i class="fas fa-user-circle userIcon" title="user manage"></i> </a>
